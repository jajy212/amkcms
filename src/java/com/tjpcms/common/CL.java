...
public class CL {
	public static final String ROOT="alitjp";//网站根目录
	public static final String DB="db_"+ROOT;//网站数据库名

	public static final String WZMC="tjpcms";//网站名称
	public static final String GGY="tjpcms 一 最懂你的cms";//广告语
	public static final String GGY2="国产Java类cms良心之作";//广告语
	public static final String YUMING="www.tjpcms.com";//域名
	public static final String META_DES="tjpcms是一套基于java的cms解决方案，开源免费。其独有的实时配置增删改查的功能，是其区别于同类cms的最大特点，也是最大优势，极大减少了重复劳动。懂jsp即可实现快速建站、静态化等，学习成本极低。文档齐全，支持有力，快来试试吧！";

	public static final String ses_admin= "ses_admin";
	public static final String ses_usr= "ses_usr";
	...
	public static final Integer SESTO_CRUD=3600;//1小时
	
	public static final String SES_MSG="listtipmsg";
}
